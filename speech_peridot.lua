...
return {
	...
	ANNOUNCE_HIGHRESEARCH = "I feel so smart now! Well, i always feel smart.",
	ANNOUNCE_HOUNDS = "Exceptionally monstrous sounds.",
	ANNOUNCE_WORMS = "Did you feel that?",
	ANNOUNCE_HUNGRY = "Theoretically, i don't even need food. Why i feel bad?",
	ANNOUNCE_HUNT_BEAST_NEARBY = "Footprint of some beast?",
	ANNOUNCE_HUNT_LOST_TRAIL = "The trail ends here.",
	ANNOUNCE_HUNT_LOST_TRAIL_SPRING = "Ugh, ground is too wet for any trails.",
	...
	ANNOUNCE_QUAKE = "Estimate chance of this being the Cluster's awakening is around 0.00012%",
	ANNOUNCE_RESEARCH = "Information is power!",
	ANNOUNCE_SHELTER = "Thanks for the protection from the elements, tree!",
	ANNOUNCE_THORNS = "Ow!",
	ANNOUNCE_BURNT = "This can destabilize my form!",
	ANNOUNCE_TORCH_OUT = "Damn you, primitive light sourse!",
	...
	ANNOUNCE_INSUFFICIENTFERTILIZER = "Ugh, greedy plant!",
	...
	DESCRIBE =
	{
		...
		THULECITE_PIECES = "Small pieces of unknown mineral.",
		POND_ALGAE = "Some algae by a pond.",
		GREENSTAFF = "For more professional and controlled destruction.",
		POTTEDFERN = "A fern in a pot.",

		THULECITE = "Very strange crystal structure. Possibly an old gem tech.",
